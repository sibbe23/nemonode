                    ...
                    const receivers = [
                        {
                         ...
                         tranEmailApi.sendTransacEmail({
                             ...
                             htmlContent: `<a>Click <a href="http://localhost:3000/password/resetpassword/${id}">here</a> to reset your password for Nsnemo</a>`,
...
const resetpassword = async (req, res) => {
    ...
    try {
        ...
        if (forgotpasswordrequest) {
            ...
            const response = await axios.post('http://localhost:3000/password/updatepassword/${id}',data)
